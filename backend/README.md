...
## Project Structure
    ...
    ├── testapiautosetting_125935  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125935`
...
2. Clone this repo and `cd testapiautosetting_125935`
